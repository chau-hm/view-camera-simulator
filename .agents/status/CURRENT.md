...
- Validation: focused teaching/geometry/scene/optics/copy suites passed; full `npm test` passed (160 files, 1,544 tests); typecheck, lint, CSS structure, build, diff check, and focused Chromium smoke passed. Chromium smoke covered side/top updates, public Tilt/Swing controls, Scheimpflug overlay, Ground Glass, and SPA scene switching.
