...
- Validation: `npm run ci:local` passed (148 test files / 1,441 tests, CSS check, lint, typecheck, and build); focused bellows/camera-body tests pass (32 tests); targeted Chromium movement/inspection suite passed 41/44, and Ground Glass interaction passed 2/3. Remaining browser failures are known RTT/GPU contentfulness, intermittent orbit, and pre-existing route-transition RTT baseline cases.
