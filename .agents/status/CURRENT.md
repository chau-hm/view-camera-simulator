...
- Main sync: latest `origin/main` `13c2ad9c46b473584162b2eb05c7cd65a113d61a` merged non-destructively; the merge commit is recorded in the publication history. No rebase was performed.
...
- `npm run ci:local`: final post-merge validation pending. Prior PR #135 CI passed CSS structure, lint, typecheck, 165 Vitest files / 1,600 tests, and production build.
