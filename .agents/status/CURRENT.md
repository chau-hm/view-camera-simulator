...
- CSS typography: `.landing-learning-section__eyebrow` and `.landing-why-section__eyebrow` are now `0.86rem` desktop and `0.78rem` mobile. Existing cyan treatment, tracking, centered `width: fit-content`, and mobile/desktop margins remain intact; the Hero eyebrow is unchanged.
