...
export const lessonZeroMessages = {
  ...
  steps: {
    ...
    imageCircle: {
      title: "認識成像圈",
      body:
        "鏡頭在相機後方形成的是圓形影像，而 4×5 底片只使用其中一個長方形範圍。大片幅鏡頭通常會在底片四周保留額外的可用成像範圍，讓前、後組可以移動，而不會立即離開鏡頭的覆蓋範圍。在大多數 35 mm、數碼單鏡反光及無反相機中，感光元件與鏡頭通常保持置中及固定相對位置，因此攝影師一般不會直接操作這些多出的成像範圍。",
      cue: "比較長方形底片與外圍較大的圓形成像。四周多出的範圍，就是上移及橫移可以利用的空間。",
    },
    frontRiseControl: {
      title: "前組上移",
      body:
        "上移會令前組向垂直方向移動，而相機支架保持原位。由於鏡頭投射的成像圈大於底片，前組移動時，成像圈相對於底片的位置亦會改變，令底片接收到圓形影像的另一部分。",
      cue: "拖動「上移」，直至清楚看到前組的垂直移動，再聯想到上一個步驟介紹的成像圈空間。",
    },
    frontShiftControl: {
      title: "前組橫移",
      body:
        "橫移會令前組向側面移動，但不會旋轉。它同樣利用底片四周多出的成像範圍，改變鏡頭與底片的相對位置。",
      cue: "拖動「前組橫移」，直至清楚看到橫向移動，再聯想到成像圈四周多出的空間。",
    },
    frontTiltControl: {
      title: "前組傾斜",
