...
export const lessonZeroMessages = {
  ...
  steps: {
    ...
    imageCircle: {
      title: "認識成像圈",
      body:
        "概念上，有限的鏡頭成像範圍會在與光軸垂直的平面上形成圓形成像圈。4×5 底片長方形只使用其中一部分，邊緣周圍仍有多出的覆蓋空間。這只是教學示意，並非任何特定鏡頭的實測成像資料。前組上移與橫移會改變投影覆蓋範圍相對底片的位置。",
      cue: "比較 4×5 底片長方形與外圍較大的玫瑰紅成像圈。多出的範圍就是上移及橫移可以利用的空間。",
    },
    frontRiseControl: {
      title: "前組上移",
      body:
        "前組上移會令鏡頭及前組垂直移動，而後組與底片長方形保持原位。投影成像圈會相對底片移動，利用上方或下方多出的覆蓋空間。",
      cue: "拖動「上移」，觀察玫瑰紅覆蓋範圍相對 4×5 底片長方形移動；這就是上移所利用的垂直空間。",
    },
    frontShiftControl: {
      title: "前組橫移",
      body:
        "前組橫移會令鏡頭及前組向側面移動，但不會旋轉；後組與底片長方形保持原位。同一個投影成像圈會相對底片移動，利用左方或右方多出的覆蓋空間。",
      cue: "拖動「前組橫移」，觀察玫瑰紅覆蓋範圍相對 4×5 底片長方形移動；這就是橫移所利用的水平空間。",
    },
    frontTiltControl: {
      title: "前組傾斜",
