...
export const simulatorMessages = {
  ...
  geometry: {
    ...
    obliqueTabletopTiltFeedback: "近遠方向的對齊有所改善，但左右方向的偏差仍然存在。",
    obliqueTabletopSwingFeedback: "左右方向的部分正在改變；比較它與近遠方向的關係。",
    obliqueTabletopCompoundFeedback: "前組俯仰與前組擺動共同定位同一個三維清晰焦平面。",
