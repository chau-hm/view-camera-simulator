...
export const simulatorMessages = {
  ...
  freePractice: {
    ...
    macroBellowsExtension: {
      ...
      observe: "將標本與每格 1 cm 的對焦屏網格比較，並觀察後組隨皮腔伸長而移動。開大光圈可以令對焦時的影像更明亮，但不會改變重現的幾何關係。",
      whyItMatters: "大畫幅相機透過增加鏡頭至底片的距離，達到高重現比例。這同時會增加放大倍率及皮腔因子造成的曝光代價；開大光圈有助對焦，但不會消除這項代價。",
      stages: {
        early: {
          title: "早段近距離對焦",
