...
export const simulatorMessages = {
  ...
  freePractice: {
    ...
    macroBellowsExtension: {
      ...
      goal: "達到標本的等大重現。在 1:1 時，底片上的影像與實物大小相同。成像圈是固定影像平面上的投影覆蓋範圍，與主體放大倍率是不同概念。",
      ...
      stages: {
        early: {
          ...
          coverage: "鏡頭至底片距離（{{extension}}）已超過無限遠對焦參考位置。根據目前固定角度的成像範圍模型，成像圈直徑為 {{imageCircle}}，大於無限遠參考值；4×5 底片畫幅維持不變。",
        },
        intermediate: {
          title: "接近等大",
        ...
        lifeSize: {
          ...
          coverage: "在 1:1 時（影像距離約為 2f），模擬器目前固定角度的成像範圍模型投射出直徑 {{imageCircle}} 的成像圈，約為無限遠參考值的兩倍。伸長為 {{extension}}；皮腔因子 {{factor}} 需要 {{stops}} 曝光補償，在光圈不變時會令對焦屏變暗。成像圈是覆蓋範圍，並非主體影像；4×5 底片維持不變。",
        },
      },
