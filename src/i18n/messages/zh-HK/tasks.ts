...
export const tasksMessages = {
  ...
  results: {
    ...
    interiorCornerSwingOrientation: {
      pass: "前組擺動已改善牆面焦平面的方向",
      fail: "前組擺動仍未建立牆面焦平面的方向",
    },
    interiorCornerWallFocus: {
      pass: "牆面近處、中間及遠處細節都清晰",
      fail: "延伸牆面仍有部分細節偏柔",
    },
  ...
  obliqueTabletopFocus: {
    title: "對焦桌面中央",
    objective: "先對焦桌面中央位置。留意單靠對焦只會移動焦平面，並不能配合桌面的方向。",
    notes: {
      focus: "以桌面中央位置作為參考，再比較其他看得見的近、遠、左、右位置。",
      constraints: "保持前組俯仰及前組擺動為零。光圈固定在 f/11，暫時不要嘗試解決整張桌面。",
    },
    criteria: {
      ...
      middleSharp: "桌面中央位置清晰",
    },
    feedback: {
      passPrimary: "很好。對焦已將焦平面放到中央位置；桌面其他方向仍然與它不一致。",
      defaultFailPrimary: "先對焦桌面中央位置，再比較周圍近、遠、左、右位置的清晰度。",
      primary: {
        ...
        middleSharp: "以桌面中央位置作為參考，微調對焦直到清晰。",
      },
      secondary: {
        allowedAperture: "固定 f/11，令比較集中於焦平面的位置。",
        riseZero: "桌面構圖已經完成；保持相機位置不變。",
        tiltZero: "對焦會把焦平面前後移動；稍後再用前組俯仰處理近遠方向。",
        swingZero: "先在中央位置建立對焦，再改變桌面焦平面的方向。",
        focusUsed: "比較調整前後的對焦讀數，觀察焦平面如何移到中央位置。",
        middleSharp: "中央位置清晰後，留意桌面其他位置仍然偏柔。",
      },
    },
  },
  obliqueTabletopTilt: {
    title: "改善近遠方向的對焦",
    objective: "使用前組俯仰，配合側視圖改善近遠方向的關係；需要時再微調對焦。",
    notes: {
      tilt: "使用負向前組俯仰，令桌面近處、中間及遠處位置更接近同一個清晰焦平面。",
    ...
    feedback: {
      ...
      primary: {
        ...
        nearSharp: "近中央位置仍然偏柔。先使用負向前組俯仰，再微調對焦。",
        middleSharp: "調整前組俯仰時，以中央位置作為對焦參考。",
        farSharp: "遠中央位置仍然偏柔。繼續使用負向前組俯仰並微調對焦。",
      },
      secondary: {
        allowedAperture: "固定 f/11，令這一步集中於焦平面方向而不是額外景深。",
        riseZero: "使用側視幾何圖觀察焦平面，不要改變相機位置。",
        swingZero: "保留未解決的左右方向，令前組俯仰的效果清楚可見。",
        movementRange: "比較綠色清晰焦平面與桌面由近至遠的軌跡；不要用正向俯仰走捷徑。",
        nearSharp: "比較近中央與中央、遠中央的清晰度讀數。",
        middleSharp: "每次調整俯仰後，以中央位置作為對焦參考。",
        farSharp: "這個改善只沿一個方向發生；側視圖仍應顯示左右方向的問題。",
      },
    },
  },
  obliqueTabletopSwing: {
    title: "加入左右方向的調整",
    objective: "加入前組擺動，改善餘下的左右方向關係，同時保留已建立的近遠方向俯仰關係。",
    notes: {
      swing: "保留有效的近遠方向俯仰關係，再加入負向前組擺動及微調對焦，改善左右方向。",
      constraints: "保持前組上移為零，並將光圈留在 f/11。比較左右位置；所有看得見的桌面位置清晰會留到下一步。",
    },
    criteria: {
      allowedAperture: "光圈保持在 f/11",
      riseZero: "前組上移保持在 0 mm",
    ...
    feedback: {
      passPrimary: "很好。前組擺動已改善左右方向的關係；下一步再微調對焦，把已定好方向的複合焦平面準確放到桌面上。",
      defaultFailPrimary: "保留有效的負向前組俯仰，在俯視圖加入負向前組擺動，並比較左右位置。所有桌面位置清晰會留到下一步。",
      primary: {
        ...
        lateralSharp: "遠排左右位置仍未接近清晰。保留有效俯仰，加入負向擺動並微調對焦。",
      },
      secondary: {
        allowedAperture: "使用俯視圖及 f/11 比較移軸組合，不要依靠額外景深。",
        riseZero: "比較左右位置時，不要改變相機位置。",
        tiltRange: "只有保留有效的近遠俯仰關係，俯視圖才可以清楚顯示擺動的作用。",
        movementRange: "比較綠色清晰焦平面與桌面左右方向的軌跡；正向擺動會令它轉離桌面。",
        focusUsed: "任何移軸都可能改變焦平面位置，因此先微調對焦再判斷結果。",
        lateralSharp: "先比較遠排左右位置，並記住所有看得見的桌面位置清晰是下一步的目標。",
      },
    },
  },
  obliqueTabletopRefine: {
    title: "放置複合清晰焦平面",
    objective: "當俯仰與擺動定好焦平面的方向後，再微調對焦，令桌面不同位置落在同一個清晰焦平面上。",
    notes: {
      focus: "保持兩個移軸方向在有效關係附近，用對焦把形成的焦平面放到桌面上。",
      constraints: "保持前組上移為零及光圈在 f/11。比較整組看得見的桌面位置，而不是只看一個目標。",
    },
    criteria: {
      allowedAperture: "光圈保持在 f/11",
      riseZero: "前組上移保持在 0 mm",
      ...
      allTargetsSharp: "所有看得見的桌面位置清晰",
    },
    feedback: {
      passPrimary: "複合焦平面已經在 f/11 放到桌面上。下一步會在這個已對齊的焦平面周圍增加景深。",
      defaultFailPrimary: "保持俯仰及擺動在有效的複合關係附近，再比較所有看得見的桌面位置並微調對焦。",
      primary: {
        ...
        focusUsed: "由起始位置微調對焦，將複合焦平面放到桌面上。",
        allTargetsSharp: "部分可見位置仍然偏柔。比較整組目標並微調對焦，同時保留複合移軸關係。",
      },
      secondary: {
        ...
        allTargetsSharp: "比較近遠及左右兩組位置；一個清晰目標不足以證明已經對齊。",
      },
    },
  },
  obliqueTabletopAperture: {
    ...
    criteria: {
      ...
      tiltRange: "前組俯仰保持在校準的複合關係附近",
      swingRange: "前組擺動保持在校準的複合關係附近",
      allTargetsSharp: "已對齊的可見桌面位置保持清晰",
    },
    feedback: {
      passPrimary: "完成。前組俯仰與擺動定位同一個三維清晰焦平面，對焦把它放到桌面上，最後用較細光圈在焦平面周圍增加景深。",
      ...
      primary: {
        ...
        allTargetsSharp: "桌面尚未完全對齊；光圈不能取代正確的俯仰、擺動及對焦。",
      },
      secondary: {
        allowedAperture: "收細幅度是刻意保持適度，為已對齊的焦平面增加容錯。",
        riseZero: "比較焦平面周圍景深時，保持相機及桌面構圖不變。",
