...
export const tasksMessages = {
  ...
  obliqueTabletopSwing: {
    title: "加入左右方向的調整",
    objective: "再使用前組擺動，配合俯視圖處理餘下的左右方向差異。",
    notes: {
      swing: "保留有效的前組俯仰關係，再加入負向前組擺動處理左右方向。",
      constraints: "保持前組上移為零，並將光圈留在 f/11。比較桌面所有看得見的位置。",
    },
    criteria: {
      allowedAperture: "光圈保持在 f/11",
      riseZero: "前組上移保持在 0 mm",
      tiltRange: "前組俯仰保持在校準的複合關係附近",
      movementRange: "前組擺動處於校準的負值範圍",
      allTargetsSharp: "所有看得見的桌面位置清晰",
    },
    feedback: {
      passPrimary: "很好。前組擺動處理了餘下的左右方向，同時前組俯仰維持近遠方向的對齊。",
      defaultFailPrimary: "保留校準的負向前組俯仰，在俯視圖加入負向前組擺動，並比較所有看得見的桌面位置。",
      primary: {
        allowedAperture: "保持光圈在 f/11；先用移軸解決焦平面，再收細光圈。",
        riseZero: "將前組上移恢復至 0 mm；這一步加入左右方向的光學調整。",
        tiltRange: "保持前組俯仰在校準的複合關係附近，讓擺動處理餘下的方向。",
        movementRange: "使用校準的負向前組擺動；相反方向會令左右關係轉錯方向。",
        allTargetsSharp: "部分桌面位置仍然偏柔。保持俯仰關係，微調負向擺動及對焦。",
      },
      secondary: {
        ...
        allTargetsSharp: "比較近、遠兩排的左、中、右位置，不要只看一張卡。",
      },
    },
  },
