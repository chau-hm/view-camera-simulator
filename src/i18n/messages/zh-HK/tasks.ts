...
export const tasksMessages = {
  ...
  obliqueTabletopTilt: {
    ...
    notes: {
      tilt: "使用正向前組俯仰，令圖板近處、中間及遠處細節更接近同一個清晰焦平面。",
  ...
  obliqueTabletopRefine: {
    ...
    notes: {
      focus: "保持已建立的俯仰及擺動方向，用對焦把形成的焦平面放到主體圖板上。",
      constraints: "保持前組上移為零及光圈在 f/11。只微調對焦，並比較整組看得見的圖板位置。",
    },
    criteria: {
      allowedAperture: "光圈保持在 f/11",
      riseZero: "前組上移保持在 0 mm",
    ...
    feedback: {
      ...
      defaultFailPrimary: "保持已建立的俯仰及擺動方向，再比較所有看得見的圖板位置並微調對焦。",
      primary: {
        ...
        allTargetsSharp: "部分可見圖板細節仍然偏柔。比較整組目標並只微調對焦，同時保留已建立的移軸關係。",
      },
      secondary: {
