...
export const tasksMessages = {
  ...
  obliqueTabletopFocus: {
    title: "對焦主體圖板中央",
    objective: "先對焦主體圖板中央位置。留意單靠對焦只會移動焦平面，並不能配合傾斜圖板的方向。",
    notes: {
      focus: "以主體圖板中央位置作為參考，再比較其他看得見的近、遠、左、右細節。",
      constraints: "保持前組俯仰及前組擺動為零。光圈固定在 f/11，暫時不要嘗試解決整塊圖板。",
    },
    criteria: {
      allowedAperture: "光圈保持在 f/11",
      riseZero: "前組上移保持在 0 mm",
      tiltZero: "前組俯仰保持在 0°",
      swingZero: "前組擺動保持在 0°",
      focusUsed: "對焦距離由起始位置改變至少 100 mm",
      middleSharp: "主體圖板中央位置清晰",
    },
    feedback: {
      passPrimary: "很好。對焦已將焦平面放到中央位置；主體圖板其他方向仍然與它不一致。",
      defaultFailPrimary: "先對焦主體圖板中央位置，再比較周圍近、遠、左、右細節的清晰度。",
      primary: {
        allowedAperture: "保持光圈在 f/11；第一步只處理焦平面的位置。",
        riseZero: "將前組上移恢復至 0 mm；這一步先處理對焦，不要改變相機移軸。",
        tiltZero: "建立中央對焦參考之前，保持前組俯仰在 0°。",
        swingZero: "建立中央對焦參考之前，保持前組擺動在 0°。",
        focusUsed: "由起始位置調整對焦，讓焦平面的移動清楚可見。",
        middleSharp: "以主體圖板中央位置作為參考，微調對焦直到清晰。",
      },
      secondary: {
        allowedAperture: "固定 f/11，令比較集中於焦平面的位置。",
        riseZero: "主體圖板構圖已經完成；保持相機位置不變。",
        tiltZero: "對焦會把焦平面前後移動；稍後再用前組俯仰處理圖板近遠方向。",
        swingZero: "先在中央位置建立對焦，再改變主體圖板焦平面的方向。",
        focusUsed: "比較調整前後的對焦讀數，觀察焦平面如何移到中央位置。",
        middleSharp: "中央位置清晰後，留意圖板其他細節仍然偏柔。",
      },
    },
  },
  obliqueTabletopTilt: {
    title: "改善近遠方向的對焦",
    objective: "使用前組俯仰，配合側視圖改善主體圖板近遠方向的關係；需要時再微調對焦。",
    notes: {
      tilt: "使用負向前組俯仰，令圖板近處、中間及遠處細節更接近同一個清晰焦平面。",
      constraints: "保持前組上移及前組擺動為零。光圈固定在 f/11；這一步只會部分改善問題。",
    },
    criteria: {
      allowedAperture: "光圈保持在 f/11",
      riseZero: "前組上移保持在 0 mm",
      swingZero: "前組擺動保持在 0°",
      movementRange: "前組俯仰處於校準的負值範圍",
      nearSharp: "圖板近中央細節清晰",
      middleSharp: "圖板中央細節清晰",
      farSharp: "圖板遠中央細節清晰",
    },
    feedback: {
      passPrimary: "很好。前組俯仰及對焦改善了主要的近遠關係；左右方向的差異會留待下一步處理。",
      defaultFailPrimary: "在側視圖使用校準的負向前組俯仰，再比較近處、中間及遠處位置並微調對焦。",
      primary: {
        allowedAperture: "保持光圈在 f/11；不要用景深掩蓋錯誤的焦平面。",
        riseZero: "將前組上移恢復至 0 mm；這一步用前組俯仰改變焦平面方向。",
        swingZero: "保持前組擺動在 0°；這一步會刻意留下左右方向的差異。",
        movementRange: "使用校準的負向前組俯仰；相反方向會令近遠關係轉向錯誤的一邊。",
        nearSharp: "圖板近中央細節仍然偏柔。先使用負向前組俯仰，再微調對焦。",
        middleSharp: "調整前組俯仰時，以圖板中央細節作為對焦參考。",
        farSharp: "圖板遠中央細節仍然偏柔。繼續使用負向前組俯仰並微調對焦。",
      },
      secondary: {
        allowedAperture: "固定 f/11，令這一步集中於焦平面方向而不是額外景深。",
        riseZero: "使用側視幾何圖觀察焦平面，不要改變相機位置。",
        swingZero: "保留未解決的左右方向，令前組俯仰的效果清楚可見。",
        movementRange: "比較綠色清晰焦平面與圖板由近至遠的軌跡；不要用正向俯仰走捷徑。",
        nearSharp: "比較圖板近中央與中央、遠中央的清晰度讀數。",
        middleSharp: "每次調整俯仰後，以中央位置作為對焦參考。",
        farSharp: "這個改善只沿一個方向發生；側視圖仍應顯示圖板左右方向的問題。",
      },
    },
  },
  obliqueTabletopSwing: {
    title: "加入左右方向的調整",
    objective: "加入前組擺動，改善主體圖板餘下的左右方向關係，同時保留已建立的近遠方向俯仰關係。",
    notes: {
      swing: "保留有效的近遠方向俯仰關係，再加入負向前組擺動及微調對焦，改善圖板左右方向。",
      constraints: "保持前組上移為零，並將光圈留在 f/11。比較左右細節；所有看得見的圖板位置清晰會留到下一步。",
    },
    criteria: {
      allowedAperture: "光圈保持在 f/11",
      riseZero: "前組上移保持在 0 mm",
      tiltRange: "前組俯仰保留有效的負向近遠關係",
      movementRange: "前組擺動處於有效的負值範圍",
      focusUsed: "調整移軸後已微調對焦",
      lateralSharp: "遠排左、右位置顯示左右方向有所改善",
    },
    feedback: {
      passPrimary: "很好。前組擺動已改善左右方向的關係；下一步再微調對焦，把已定好方向的複合焦平面準確放到主體圖板上。",
      defaultFailPrimary: "保留有效的負向前組俯仰，在俯視圖加入負向前組擺動，並比較左右細節。所有圖板位置清晰會留到下一步。",
      primary: {
        allowedAperture: "保持光圈在 f/11；先用移軸解決焦平面，再收細光圈。",
        riseZero: "將前組上移恢復至 0 mm；這一步加入左右方向的光學調整。",
        tiltRange: "保持前組俯仰在有效的負向範圍，令近遠關係在擺動改善左右方向時維持清楚。",
        movementRange: "使用有效的負向前組擺動；相反方向會令左右關係轉錯方向。",
        focusUsed: "調整移軸後再微調對焦，才可以有意義地比較左右位置。",
        lateralSharp: "遠排左右細節仍未接近清晰。保留有效俯仰，加入負向擺動並微調對焦。",
      },
      secondary: {
        allowedAperture: "使用俯視圖及 f/11 比較移軸組合，不要依靠額外景深。",
        riseZero: "比較左右位置時，不要改變相機位置。",
        tiltRange: "只有保留有效的近遠俯仰關係，俯視圖才可以清楚顯示擺動的作用。",
        movementRange: "比較綠色清晰焦平面與圖板左右方向的軌跡；正向擺動會令它轉離圖板。",
        focusUsed: "任何移軸都可能改變焦平面位置，因此先微調對焦再判斷結果。",
        lateralSharp: "先比較遠排左右細節，並記住所有看得見的圖板位置清晰是下一步的目標。",
      },
    },
  },
  obliqueTabletopRefine: {
    title: "放置複合清晰焦平面",
    objective: "當俯仰與擺動定好焦平面的方向後，再微調對焦，令圖板不同位置落在同一個清晰焦平面上。",
    notes: {
      focus: "保持兩個移軸方向在有效關係附近，用對焦把形成的焦平面放到主體圖板上。",
      constraints: "保持前組上移為零及光圈在 f/11。比較整組看得見的圖板位置，而不是只看一個目標。",
    },
    criteria: {
      allowedAperture: "光圈保持在 f/11",
      riseZero: "前組上移保持在 0 mm",
      tiltRange: "前組俯仰保持在校準的複合關係附近",
      swingRange: "前組擺動保持在校準的複合關係附近",
      focusUsed: "對焦由起始位置作出微調",
      allTargetsSharp: "所有看得見的圖板細節清晰",
    },
    feedback: {
      passPrimary: "複合焦平面已經在 f/11 放到主體圖板上。下一步會在這個已對齊的焦平面周圍增加景深。",
      defaultFailPrimary: "保持俯仰及擺動在有效的複合關係附近，再比較所有看得見的圖板位置並微調對焦。",
      primary: {
        allowedAperture: "保持光圈在 f/11；先放置複合焦平面，再在它周圍增加景深。",
        riseZero: "將前組上移恢復至 0 mm；這一步只用俯仰、擺動及對焦放置焦平面。",
        tiltRange: "微調焦平面位置時，保持前組俯仰在校準的複合關係附近。",
        swingRange: "微調焦平面位置時，保持前組擺動在校準的複合關係附近。",
        focusUsed: "由起始位置微調對焦，將複合焦平面放到主體圖板上。",
        allTargetsSharp: "部分可見圖板細節仍然偏柔。比較整組目標並微調對焦，同時保留複合移軸關係。",
      },
      secondary: {
        allowedAperture: "保持 f/11，先觀察焦平面的位置，再進入光圈步驟。",
        riseZero: "使用幾何圖觀察同一個焦平面，不要改變構圖。",
        tiltRange: "側視圖顯示同一個複合焦平面的近遠方向。",
        swingRange: "俯視圖顯示同一個焦平面的左右方向。",
        focusUsed: "調整任何移軸後都要重新對焦，因為焦平面的位置及方向都可能改變。",
        allTargetsSharp: "比較近遠及左右兩組細節；一個清晰目標不足以證明已經對齊。",
      },
    },
  },
  obliqueTabletopAperture: {
    title: "在焦平面周圍增加景深",
    objective: "焦平面已經對齊。現在收細光圈，增加焦平面周圍的景深，而唔係用光圈取代移軸。",
    notes: {
      aperture: "保持複合俯仰、擺動及對焦關係，再選擇下一個適度收細的光圈。",
      constraints: "最後一步不要改變移軸或對焦；光圈只會改變已對齊焦平面周圍的可用景深。",
    },
    criteria: {
      allowedAperture: "光圈已設定為適度收細的最終值",
      riseZero: "前組上移保持在 0 mm",
      tiltRange: "前組俯仰保持在校準的複合關係附近",
      swingRange: "前組擺動保持在校準的複合關係附近",
      allTargetsSharp: "已對齊的可見圖板細節保持清晰",
    },
    feedback: {
      passPrimary: "完成。前組俯仰與擺動定位同一個三維清晰焦平面，對焦把它放到主體圖板上，最後用較細光圈在焦平面周圍增加景深。",
      defaultFailPrimary: "保持複合焦平面對齊，再收細一級適度光圈。光圈只會在焦平面周圍增加景深，不能取代移軸。",
      primary: {
        allowedAperture: "選擇最後一步的適度細光圈；不要停留在起始的 f/11。",
        riseZero: "保持前組上移在 0 mm；收細光圈不應改變已完成的構圖。",
        tiltRange: "在依靠最後光圈之前，先恢復有效的複合前組俯仰關係。",
        swingRange: "在依靠最後光圈之前，先恢復有效的複合前組擺動關係。",
        allTargetsSharp: "主體圖板尚未完全對齊；光圈不能取代正確的俯仰、擺動及對焦。",
      },
      secondary: {
        allowedAperture: "收細幅度是刻意保持適度，為已對齊的焦平面增加容錯。",
        riseZero: "比較焦平面周圍景深時，保持相機及主體圖板構圖不變。",
        tiltRange: "收細光圈後，側視圖仍然代表同一個近遠方向。",
        swingRange: "收細光圈後，俯視圖仍然代表同一個左右方向。",
        allTargetsSharp: "如果錯誤的移軸方向令影像偏柔，應先恢復焦平面對齊，而不是繼續收細光圈。",
      },
    },
  },
  tableTilt: {
