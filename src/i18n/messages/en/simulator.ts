export const simulatorMessages = {
  ...
  controls: {
    ...
    lensCopy:
      "At the same camera position, focal length changes angle of view and framing, not perspective. Lens coverage is separate from focal length: lenses with the same focal length can cover different areas. Rise and Shift use spare coverage; they do not create more.",
    lensWide: "Wide",
    lensStandard: "Standard",
    lensOptionLabel: "{{focalLength}} mm — {{label}} — {{coverage}}",
    lensCoverageLabel: "Lens coverage",
    lensCoverageNotModelled: "Not modelled",
    lensSimulatorCoverage: "{{angle}}° simulator coverage (teaching profile)",
    lensSelectedLens: "Selected lens",
    lensSelectedValue: "{{label}} · {{focalLength}} mm",
    lensFocalLengthValue: "{{focalLength}} mm",
    lensImageCircleLabel: "Image circle",
    lensReferenceImageCircleLabel: "Reference image circle",
    lensImageCircleReferenceNote:
      "This is the perpendicular reference circle. The tilted film's actual coverage is the Coverage Footprint shown in Ground Glass and 3D.",
    lensImageCircleAtInfinity: "{{diameter}} mm at ∞",
    lensImageCircleAtCurrentFocus: "{{diameter}} mm at current focus",
    lensImageCircleUnavailable: "Unavailable",
  ...
  viewport: {
    ...
    groundGlassBlurDisplayHint: "Ground Glass blur is magnified for teaching; CoC and sharpness readouts remain physical.",
  ...
  freePractice: {
    ...
    macroBellowsExtension: {
      objective: "Reach life-size reproduction (1:1) and observe how greater bellows extension increases magnification and the physical Image Circle while bellows exposure loss darkens the Ground Glass.",
      bullets: {
        ...
        consequences: "Compare magnification, the physical Image Circle, and bellows exposure compensation as Focus Distance falls; they describe different effects.",
      ...
      observation: "As the rear standard moves farther from the lens, compare the growing Image Circle diameter with increasing exposure compensation. With Optical Geometry visible, watch the rose Image Circle expand; at a fixed aperture the Ground Glass gets darker overall.",
      ...
      goal: "Reach life-size reproduction of the specimen. At 1:1, its image on the film is the same size as the real subject. The Image Circle is the projected coverage footprint on the current film plane, separate from subject magnification.",
      ...
      observe: "Compare the specimen with the 1 cm Ground Glass grid and watch the rear standard move as the bellows extends. Watch the rose Image Circle grow while the Ground Glass gets darker overall at a fixed aperture. Opening the aperture brightens the focusing view without changing the reproduction geometry.",
      whyItMatters: "Under the simulator's current fixed angular-coverage profile, greater image distance projects a larger physical Image Circle. This is a teaching model, not a universal measured claim for every real lens. Bellows exposure loss is a separate effect that dims the Ground Glass.",
      stages: {
        early: {
          ...
          coverage: "Lens-to-film distance ({{extension}}) is already beyond its infinity-focus reference. Closer focus moves the rear standard and film plane farther from the lens, while the 4×5 film rectangle keeps the same physical dimensions. The current fixed angular-coverage profile projects an Image Circle diameter of {{imageCircle}}, larger than its infinity-reference diameter.",
        },
        intermediate: {
          ...
          coverage: "The fixed angular-coverage profile gives an Image Circle diameter of {{imageCircle}}; it and magnification increase with extension. Bellows loss is separate, so at a fixed aperture the Ground Glass gets darker overall.",
        },
        nearLifeSize: {
          ...
          coverage: "Image Circle diameter is {{imageCircle}}. As image distance approaches 2f, the fixed angular-coverage model approaches twice its infinity-reference diameter while exposure compensation approaches +2 stops.",
        },
        lifeSize: {
          ...
          observe: "The specimen is now sharply reproduced at 1:1. Its 90 mm diameter spans about nine 10 mm squares on the Ground Glass.",
          ...
          coverage: "At 1:1 (image distance ≈2f), the current fixed angular-coverage profile projects an Image Circle diameter of {{imageCircle}}, about twice its infinity-reference diameter. As focus moves closer, the rear standard moves farther from the lens and carries the film plane with it; the 4×5 film rectangle keeps the same physical dimensions. Extension is {{extension}}; bellows factor {{factor}} requires {{stops}} exposure compensation and dims the Ground Glass at a fixed aperture. Image Circle is coverage, not the subject image.",
        },
      },
