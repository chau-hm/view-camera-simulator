export const simulatorMessages = {
  ...
  freePractice: {
    ...
    macroBellowsExtension: {
      ...
      goal: "Reach life-size reproduction of the specimen. At 1:1, its image on the film is the same size as the real subject. The Image Circle is the projected coverage footprint on the fixed image plane, separate from subject magnification.",
      ...
      stages: {
        early: {
          ...
          coverage: "Lens-to-film distance ({{extension}}) is already beyond its infinity-focus reference. The current fixed angular-coverage profile projects an Image Circle diameter of {{imageCircle}}, larger than its infinity-reference footprint; the 4×5 film stays fixed.",
        },
        intermediate: {
        ...
        lifeSize: {
          ...
          coverage: "At 1:1 (image distance ≈2f), the current fixed angular-coverage profile projects an Image Circle diameter of {{imageCircle}}, about twice its infinity-reference diameter. Extension is {{extension}}; bellows factor {{factor}} requires {{stops}} exposure compensation and dims the Ground Glass at a fixed aperture. Image Circle is coverage, not the subject image; the 4×5 film stays fixed.",
        },
      },
