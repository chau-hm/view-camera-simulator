...
const tiltTask: TaskDefinition = {
  ...
  criteria: [
    ...
    {
      id: "tilt-near-sharp",
      label: "Near cup stripe is sharp",
  ...
  feedbackRules: {
    ...
    failPrimaryByCriterionId: {
      ...
      "tilt-near-sharp": "The near cup stripe is soft. Fine-tune focus after setting the calibrated tilt.",
    ...
    failSecondaryByCriterionId: {
      ...
      "tilt-near-sharp": "Watch the cup stripe in Ground Glass and the near target sharpness readout.",
