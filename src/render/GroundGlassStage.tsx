...
type GroundGlassStageProps = {
  zoomEnabled?: boolean;
  imageLayer: React.ReactNode; // content that should receive the zoom/pan transform
  fixedOverlayLayer?: React.ReactNode; // content that stays fixed (labels, focus ring)
};
