...
describe("scene geometry guides", () => {
  ...
  it.each([
    ...
    ["architecture-rise", "building-mid-facade", simulatorMessageKeys.geometry.architectureRiseBuildingMidFacadeTarget],
    ...
    ["oblique-tabletop", "near-left", simulatorMessageKeys.geometry.obliqueTabletopNearLeftTarget],
    ["oblique-tabletop", "near-centre", simulatorMessageKeys.geometry.obliqueTabletopNearCentreTarget],
    ["oblique-tabletop", "near-right", simulatorMessageKeys.geometry.obliqueTabletopNearRightTarget],
    ["oblique-tabletop", "middle", simulatorMessageKeys.geometry.obliqueTabletopMiddleTarget],
    ["oblique-tabletop", "far-left", simulatorMessageKeys.geometry.obliqueTabletopFarLeftTarget],
    ["oblique-tabletop", "far-centre", simulatorMessageKeys.geometry.obliqueTabletopFarCentreTarget],
    ["oblique-tabletop", "far-right", simulatorMessageKeys.geometry.obliqueTabletopFarRightTarget],
