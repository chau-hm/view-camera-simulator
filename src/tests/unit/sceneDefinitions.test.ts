...
describe("scene definitions", () => {
  ...
  it("exposes required, lazy, and preload scene assets", () => {
    ...
    expect(sceneOrder.at(-1)).toBe("macro-compound-movements");
    ...
    expect(getNextSceneId("macro-oblique-plane")).toBe("macro-compound-movements");
    expect(getNextSceneId("macro-compound-movements")).toBeNull();
  });
});
